...
const TeamCard = ({ name, designation, desc, imageURL, linkedin, instagram }: Props) => {
    return (
        <div className="text-white snap-center w-[80vw] max-w-[450px] pr-10 flex-shrink-0 bg-p_darkgreen flex gap-8 items-center flex-col rounded-lg p-10">
            <Image className="rounded-full aspect-square" width={250} height={250} src={imageURL} alt={name} />
