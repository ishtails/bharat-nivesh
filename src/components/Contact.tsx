        ...
        <div className="px-12 lg:grid grid-cols-2 gap-16">
          <div className="flex flex-col items-left justify-center">
            <div className="py-2">
              ...
              <input className="rounded-sm h-auto border-[#8D8D8D] border-[0.5px] text-[13px] p-2 w-full" />
            </div>
            <div className="py-2">
              <label htmlFor="" className="text-[15px]">
                Email
            ...
            <div className="py-2">
              ...
              <input className="rounded-sm h-24 border-[#8D8D8D] border-[0.5px] text-[13px] p-2 w-full " />
            </div>
          ...
          <div className="relative">
            <div className="relative rounded-2xl border-[0.5px] text-white py-4 m-2 md:m-8 items-right">
              <Image
                src={contact}
                alt="contact"
